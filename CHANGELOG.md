...
### Fixed
- Исправлено: отображение changelog при обновлении

## [2.2.1] - 2025-06-24

### Added
- Добавлено: ссылка на настройки в листинге плагинов
...
### Added
- Добавлено: очистка опций при удалении плагина
- Добавлено: поддержка плагина Yoast SEO
- Добавлено: настройка подключения Гутенберга на товарах

### Changed
- Изменено: вынос условных методов в отдельный класс
- Изменено: рефакторинг методов и классов

### Fixed
- Исправлено: много мелких правок

## [2.1.1] - 2025-06-23

### Added
- Добавлено: настройка для переключения стилей и скриптов вукомерса

### Changed
- Изменено: форматирование и приведение к WPCS

### Fixed
- Исправлено: правки орфографических ошибок
